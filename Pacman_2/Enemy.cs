...
namespace Pacman_2
{
    public class Enemy
    {
        ...
        public Vector2 eatenTargetTile = new Vector2(13, 16); // Check VALUES LATER -- change if needed
        ...
        public Rectangle[] rectsDown = new Rectangle[4];
        public Rectangle[] rectsUp = new Rectangle[4];
        public Rectangle[] rectsLeft = new Rectangle[4];
        public Rectangle[] rectsRight = new Rectangle[4];
        ...
        public Enemy(int tileX, int tileY, Tile[,] tileArray)
        {
            ...
            frightenedRects[0] = new Rectangle(330,450,32,32);
            frightenedRects[1] = new Rectangle(366,450,32,32);

            frightenedRectsEnd[0] = new Rectangle(330,450,32,32);
            frightenedRectsEnd[1] = new Rectangle(366,450,32,32);
            frightenedRectsEnd[2] = new Rectangle(330,450,32,32);
            frightenedRectsEnd[3] = new Rectangle(366,450,32,32);
            frightenedRectsEnd[4] = new Rectangle(330,622,32,32);
            frightenedRectsEnd[5] = new Rectangle(366,622,32,32);
            frightenedRectsEnd[6] = new Rectangle(330,622,32,32);
            frightenedRectsEnd[7] = new Rectangle(366,622,32,32);
